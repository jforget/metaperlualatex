...
\veilmidihhmmss{} à \directlua{sectohms(\jourmidi)}, soit \deltamidi{} secondes.
...
passant de \veilaubehhmmss{} à \directlua{sectohms(\jouraube)},
...
solaire retarde de \deltamidi~secondes, passant de \veilmidihhmmss{} à \directlua{sectohms(\jourmidi)}.
Le lever du soleil progresse donc de :

\formuleaube{}

c'est-à-dire qu'il retarde de \deltaaube~secondes, passant
de \veilaubehhmmss{} à \directlua{sectohms(\jouraube)}, tandis que le
coucher du soleil progresse de :

\formulesoir{}

c'est-à-dire que le coucher du soleil retarde de \deltasoir~secondes,
passant de \veilsoirhhmmss{} à \directlua{sectohms(\joursoir)}.
